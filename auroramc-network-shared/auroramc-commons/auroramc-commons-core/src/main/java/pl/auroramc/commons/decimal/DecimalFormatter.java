...
public class DecimalFormatter {
  ...
  private static final long[] SCALE_FACTORS = { 1_000, 1_000_000, 1_000_000_000, 1_000_000_000_000L, 1_000_000_000_000_000L, 1_000_000_000_000_000_000L };
  ...
  public static String getFormattedDecimal(final double amount) {
    ...
    return getFormattedAmountWithSuffix(amount, SCALE_FACTORS[nearestScaleDivider], SCALE_SUFFIXES[nearestScaleDivider]);
  }
  ...
  private static String getTruncatedAmount(final double amount) {
    ...
    fractionalPart *= 100;
    fractionalPart = (fractionalPart < 99 && fractionalPart % 1 >= 0.5) ? ceil(fractionalPart) : floor(fractionalPart);
