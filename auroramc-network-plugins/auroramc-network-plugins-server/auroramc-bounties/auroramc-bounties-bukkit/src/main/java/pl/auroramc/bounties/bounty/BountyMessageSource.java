...
public class BountyMessageSource extends OkaeriConfig {
  ...
  public MutableMessage bountyTitle = MutableMessage.of("<gradient:#f5c894:#f6d4a2:#f9e2b4:#f6d4a2:#f5c894><bold>Dzień <day>");

  public MutableMessage bountyAvailable =
      MutableMessage.of("<gradient:#f5c894:#f6d4a2:#f9e2b4:#f6d4a2:#f5c894>Naciśnij <gradient:#f7cf78:#fbd06a:#f4b352:#fbd06a:#f7cf78><bold><gradient:#f7cf78:#fbd06a:#f4b352:#fbd06a:#f7cf78>LPM</bold><gradient:#f5c894:#f6d4a2:#f9e2b4:#f6d4a2:#f5c894>, aby odebrać tą nagrodę.");

  public MutableMessage bountyAvailableSinceTomorrow =
      MutableMessage.of("<gradient:#f5c894:#f6d4a2:#f9e2b4:#f6d4a2:#f5c894>Nagroda ta będzie dla ciebie dostępna do odebrania już jutro.");

  public MutableMessage remainingTimeUntilBounty =
      MutableMessage.of("<gradient:#f5c894:#f6d4a2:#f9e2b4:#f6d4a2:#f5c894>Nagrodę będziesz mógł odebrać za <gradient:#f7cf78:#fbd06a:#f4b352:#fbd06a:#f7cf78><remaining_time><gradient:#f5c894:#f6d4a2:#f9e2b4:#f6d4a2:#f5c894>.");
