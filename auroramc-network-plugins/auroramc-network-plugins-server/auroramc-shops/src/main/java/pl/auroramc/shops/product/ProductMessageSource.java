...
public class ProductMessageSource extends OkaeriConfig {
  ...
  public MutableMessage purchaseTag =
      MutableMessage.of(
          "<gradient:#c95e7b:#ed7d95:#ed7d95:#b55e7b>Cena zakupu: <#f4a9ba><context.currency.@symbol><context.price>");
  ...
  public MutableMessage sellTag =
      MutableMessage.of(
          "<gradient:#c95e7b:#ed7d95:#ed7d95:#b55e7b>Cena sprzedaży: <#f4a9ba><context.currency.@symbol><context.price>");

  public MutableMessage sellSuggestion =
      MutableMessage.of(
          "<gradient:#f5c894:#f6d4a2:#f9e2b4:#f6d4a2:#f5c894>Naciśnij <gradient:#f7cf78:#fbd06a:#f4b352:#fbd06a:#f7cf78><bold>PPM</bold><gradient:#f5c894:#f6d4a2:#f9e2b4:#f6d4a2:#f5c894>, aby sprzedać ten przedmiot.");
}
