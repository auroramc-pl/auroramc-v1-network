...
public class MessageSource extends OkaeriConfig {
  ...
  public MutableMessage productBought =
      MutableMessage.of(
          "<gray>Zakupiłeś <white>{product} <gray>w zamian za <white>{currency}{amount}<gray>, które zostały pobrane z twojego konta.");
  ...
  public MutableMessage productSold =
      MutableMessage.of(
          "<gray>Sprzedałeś <white>{product} <gray>w zamian za <white>{currency}{amount}<gray>, które zostały przelane na twoje konto.");
  ...
  public MutableMessage purchaseTag =
      MutableMessage.of("<gray>Cena zakupu: <white>{currency}{price}");
  ...
  public MutableMessage sellTag =
      MutableMessage.of("<gray>Cena sprzedaży: <white>{currency}{price}");
