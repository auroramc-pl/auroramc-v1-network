...
public class MutableMessageSource extends OkaeriConfig {
  ...
  public MutableMessage chequeIssued =
      MutableMessage.of("<gray>Wystawiłeś czek o wartości <white>{currency}{amount}<gray>.");

  public MutableMessage chequeCouldNotBeCreatedBecauseOfDigits =
      MutableMessage.of(
  ...
  public MutableMessage chequeCouldNotBeCreatedBecauseOfAmount =
      MutableMessage.of(
  ...
  public MutableMessage chequeCouldNotBeCreatedBecauseOfMoney =
      MutableMessage.of(
  ...
  public MutableMessage titleOfCheque =
      MutableMessage.of("<gray>Czek <dark_gray>(<white>{currency}{amount}<dark_gray>)");

  public MutableMessage linesOfCheque = MutableMessage.of("<gray>Wystawiający: <white>{issuer}");
}
