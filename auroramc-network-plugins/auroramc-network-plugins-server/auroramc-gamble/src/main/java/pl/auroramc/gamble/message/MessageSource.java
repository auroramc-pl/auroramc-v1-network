...
public class MessageSource extends OkaeriConfig {
  ...
  public MutableMessage stakeMissingBalance =
      MutableMessage.of(
          "<gradient:#b51c1c:#d33131:#c72929:#d33131:#b51c1c>Nie posiadasz wystarczających środków aby utworzyć ten zakład.");

  public MutableMessage stakeMustBeGreaterThanZero =
      MutableMessage.of(
          "<gradient:#b51c1c:#d33131:#c72929:#d33131:#b51c1c>Stawka musi być większa od zera.");
  ...
  public MutableMessage stakeFinalizationSelf =
      MutableMessage.of(
          "<gradient:#b51c1c:#d33131:#c72929:#d33131:#b51c1c>Nie możesz dołączyć do własnego zakładu.");

  public MutableMessage stakeFinalizationMissingBalance =
      MutableMessage.of(
          "<gradient:#b51c1c:#d33131:#c72929:#d33131:#b51c1c>Nie posiadasz wystarczających środków aby dołączyć do tego zakładu.");

  public MutableMessage stakesTitle = MutableMessage.of("Oczekujące zakłady");

  public MutableMessage stakeName =
      MutableMessage.of(
          "<gradient:#f5c894:#f6d4a2:#f9e2b4:#f6d4a2:#f5c894><bold>Zakład <#d3a37e>(<gradient:#f7cf78:#fbd06a:#f4b352:#fbd06a:#f7cf78><context.gambleKey><#d3a37e>)");
  ...
  public MutableMessage stakeBrief =
      empty()
          ...
          .append(
              MutableMessage.of(
                  "<gradient:#c95e7b:#ed7d95:#ed7d95:#b55e7b>Gracz: <#f4a9ba><context.initiator.username>"))
          .append(
              MutableMessage.of(
                  "<gradient:#c95e7b:#ed7d95:#ed7d95:#b55e7b>Wybór: <#f4a9ba><context.initiator.prediction>"))
          .append(
              MutableMessage.of(
                  "<gradient:#c95e7b:#ed7d95:#ed7d95:#b55e7b>Stawka: <#f4a9ba><currency.@symbol><context.stake>"))
          .append(empty())
          .append(
              MutableMessage.of(
                  "<gradient:#f5c894:#f6d4a2:#f9e2b4:#f6d4a2:#f5c894>Naciśnij <gradient:#f7cf78:#fbd06a:#f4b352:#fbd06a:#f7cf78><bold>LPM</bold><gradient:#f5c894:#f6d4a2:#f9e2b4:#f6d4a2:#f5c894>, aby dołączyć do zakładu."));
