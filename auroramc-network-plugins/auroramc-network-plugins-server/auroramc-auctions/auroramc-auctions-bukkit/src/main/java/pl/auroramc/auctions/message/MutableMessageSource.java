...
public class MutableMessageSource extends OkaeriConfig {
  ...
  public DeliverableMutableMessage auctionQueueIsFull =
      DeliverableMutableMessage.of(
          MutableMessage.of(
              "<red>Musisz spróbować wystawić przedmiot później, gdyż aktualnie osiągnięty został limit oczekujących aukcji."));

  public DeliverableMutableMessage requiresHoldingItem =
      DeliverableMutableMessage.of(
          MutableMessage.of(
              "<red>Musisz trzymać przedmiot w ręce, aby móc go wystawić na aukcję."));

  public DeliverableMutableMessage invalidStock =
      DeliverableMutableMessage.of(
          MutableMessage.of("<red>Wprowadzony przez ciebie nakład jest nieprawidłowy."));

  public DeliverableMutableMessage invalidStockBecauseOfMissingItems =
      DeliverableMutableMessage.of(
          MutableMessage.of(
              "<red>Wprowadzony przez ciebie nakład przewyższa posiadane przez ciebie przedmioty."));

  public DeliverableMutableMessage invalidMinimalPrice =
      DeliverableMutableMessage.of(
          MutableMessage.of("<red>Wprowadzona przez ciebie kwota startowa jest nieprawidłowa."));

  public DeliverableMutableMessage invalidMinimalPricePuncture =
      DeliverableMutableMessage.of(
          MutableMessage.of("<red>Wprowadzona przez ciebie kwota przebicia jest nieprawidłowa."));

  public DeliverableMutableMessage auctionSchedule =
      DeliverableMutableMessage.of(
          MutableMessage.of(
              "<gray>Trzymany przez ciebie przedmiot został wystawiony. Aukcja rozpocznie się, gdy nadejdzie jej kolej."));

  public DeliverableMutableMessage offerMissingAuction =
      DeliverableMutableMessage.of(
          MutableMessage.of(
              "<red>Nie możesz złożyć oferty, gdyż w tej chwili nie trwa żadna aukcja."));

  public DeliverableMutableMessage offerSelfAuction =
      DeliverableMutableMessage.of(
          MutableMessage.of("<red>Nie możesz złożyć oferty, gdyż jest to twoja aukcja."));

  public DeliverableMutableMessage offerIsAlreadyHighest =
      DeliverableMutableMessage.of(
          MutableMessage.of(
              "<red>Nie możesz złożyć następnej oferty, gdyż twoja oferta jest w tej chwili największa."));

  public DeliverableMutableMessage offerIsSmallerThanHighestOffer =
      DeliverableMutableMessage.of(
          MutableMessage.of(
              "<red>Nie możesz złożyć oferty, gdyż jest ona mniejsza od aktualnej oferty."));

  public DeliverableMutableMessage offerNotEnoughBalance =
      DeliverableMutableMessage.of(
          MutableMessage.of("<red>Nie posiadasz wystarczająco pieniędzy, aby złożyć tą ofertę."));

  public DeliverableMutableMessage offered =
      DeliverableMutableMessage.of(
          MutableMessage.of("<gray>Złożyłeś ofertę w wysokości <white>{currency}{offer}<gray>."));

  public DeliverableMutableMessage offeringFailed =
      DeliverableMutableMessage.of(
          MutableMessage.of("<red>Wystąpił nieoczekiwany błąd podczas złożenia oferty."));

  public DeliverableMutableMessage auctionIsMissing =
      DeliverableMutableMessage.of(MutableMessage.of("<red>W tej chwili nie trwa żadna aukcja."));

  public DeliverableMutableMessage auctionWinningBid =
      DeliverableMutableMessage.of(
          MutableMessage.of("<white>{currency}{offer} <dark_gray>(<white>{trader}<dark_gray>)"));

  public DeliverableMutableMessage auctionSummary =
      DeliverableMutableMessage.of(
          MutableMessage.of(
                  """
  ...
  public DeliverableMutableMessage unknownOffer =
      DeliverableMutableMessage.of(MutableMessage.of("<white>Brak"));

  public DeliverableMutableMessage unknownPlayer =
      DeliverableMutableMessage.of(MutableMessage.of("<gray>Nieznany"));

  public DeliverableMutableMessage notificationsEnabled =
      DeliverableMutableMessage.of(
          MutableMessage.of("<gray>Włączyłeś wyświetlanie powiadomień dotyczących aukcji."));

  public DeliverableMutableMessage notificationsDisabled =
      DeliverableMutableMessage.of(
          MutableMessage.of("<gray>Wyłączyłeś wyświetlanie powiadomień dotyczących aukcji."));

  public DeliverableMutableMessage auctionNearCompletion =
      DeliverableMutableMessage.of(
          MutableMessage.of(
              "<gray><hover:show_text:'<gray>Unikalny identyfikator: <white>{uniqueId}'>Aukcja</hover> <gray>zakończy się za <white>{period}s<gray>."));

  public DeliverableMutableMessage auctionHasStarted =
      DeliverableMutableMessage.of(
          MutableMessage.of(
  ...
  public DeliverableMutableMessage auctionHasCompletedWithoutOffers =
      DeliverableMutableMessage.of(
          MutableMessage.of(
  ...
  public DeliverableMutableMessage auctionHasCompleted =
      DeliverableMutableMessage.of(
          MutableMessage.of(
  ...
  public DeliverableMutableMessage auctionReceivedOffer =
      DeliverableMutableMessage.of(
          MutableMessage.of(
  ...
  public DeliverableMutableMessage auctionHasBeenExtended =
      DeliverableMutableMessage.of(
          MutableMessage.of(
  ...
  public DeliverableMutableMessage vaultItemReceived =
      DeliverableMutableMessage.of(
          MutableMessage.of(
  ...
  public DeliverableMutableMessage vaultItemRedeemed =
      DeliverableMutableMessage.of(
          MutableMessage.of("<gray>Odebrałeś <white>{subject} <gray>ze swojego schowka."));

  public DeliverableMutableMessage vaultItemRedeemSuggestion =
      DeliverableMutableMessage.of(MutableMessage.of("<gray>Naciśnij aby odebrać ten przedmiot."));
}
