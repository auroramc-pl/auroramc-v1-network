...
public class AuctionMessageSource extends OkaeriConfig {
  ...
  public MutableMessage auctionSummary =
      MutableMessage.of(
          ...
          <dark_gray>► <gray>Przedmiot: <white>{auction.@resolvedSubject}</hover>
  ...
  public MutableMessage auctionHasStarted =
      MutableMessage.of(
          "<gray>Gracz <white>{auction.vendor}</white> rozpoczął <hover:show_text:'<gray>Unikalny identyfikator: <white>{auction.@auctionUniqueId}'>aukcję</hover> o przedmiot <white>{auction.@resolvedSubject}</hover></white><gray>. Kwota początkowa wynosi <white>{currency.@symbol}{auction.@minimalPrice}</white>, a minimalna kwota przebicia to <white>{currency.@symbol}{auction.@minimalPricePuncture}</white>.");
  ...
  public MutableMessage auctionHasCompleted =
      MutableMessage.of(
          "<gray><hover:show_text:'<gray>Unikalny identyfikator: <white>{auction.@auctionUniqueId}'>Aukcja</hover> gracza <white>{auction.vendor}</white> zakończyła się. Przedmiot <white>{auction.@resolvedSubject}</hover></white> został sprzedany za <white>{currency.@symbol}{auction.@currentOffer}</white> graczowi <white>{auction.trader}</white>.");

  public MutableMessage auctionReceivedOffer =
      MutableMessage.of(
          "<gray>Gracz <white>{auction.trader}</white> złożył ofertę <white>{currency.@symbol}{auction.@currentOffer}</white> na <hover:show_text:'<gray>Unikalny identyfikator: <white>{auction.@auctionUniqueId}'>aukcję</hover> o przedmiot <white>{auction.@resolvedSubject}</hover></white>.");
