...
import static pl.auroramc.economy.balance.leaderboad.SqlLeaderboardRepositoryQuery.GET_LEADERBOARD_ENTRIES_BY_BALANCE_ASCENDING;
import static pl.auroramc.economy.balance.leaderboad.SqlLeaderboardRepositoryQuery.GET_LEADERBOARD_ENTRY_BY_UNIQUE_ID;
...
class SqlLeaderboardRepository implements LeaderboardRepository {
  ...
  @Override
  public Optional<LeaderboardEntry> getLeaderboardEntryByUniqueId(
    ...
    try (
      ...
      final ResultSet resultSet = statement.executeQuery();
      if (resultSet.next()) {
        return Optional.of(mapResultSetToLeaderboardEntry(resultSet));
      }
