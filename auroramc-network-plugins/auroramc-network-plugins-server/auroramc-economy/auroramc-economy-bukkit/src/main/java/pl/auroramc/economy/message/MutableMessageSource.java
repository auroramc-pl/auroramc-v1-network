...
public class MutableMessageSource extends OkaeriConfig {
  ...
  public MutableMessage missingCurrency =
      MutableMessage.of(
  ...
  public MutableMessage leaderboardHeader =
      MutableMessage.of("<gray>Ranking najbogatszych graczy:<newline>");
  ...
  public MutableMessage balanceSummaryHeaderTargeted =
      MutableMessage.of("<gray>Podsumowanie stanu konta gracza <white>{username}<gray>:");

  public MutableMessage balanceSummaryEntry =
      MutableMessage.of("<dark_gray>► <gray>{name} <dark_gray>- <white>{currency}{balance}");
  ...
  public MutableMessage incomingPaymentsHeader =
      MutableMessage.of("<gray>Płatności przychodzące dla <white>{username}<dark_gray>:");

  public MutableMessage outgoingPaymentsHeader =
      MutableMessage.of("<gray>Płatności wychodzące od <white>{username}<dark_gray>:");
  ...
  public MutableMessage transferAmountHasToBeGreaterThanZero =
      MutableMessage.of("<red>Kwota musi być większa od zera.");

  public MutableMessage transferRequiresTarget =
      MutableMessage.of("<red>Nie możesz przelać pieniędzy samemu sobie.");

  public MutableMessage transferMissingBalance =
      MutableMessage.of(
  ...
  public MutableMessage modificationAmountHasToBeGreaterThanZero =
      MutableMessage.of("<red>Kwota musi być większa od zera.");

  public MutableMessage modificationFailed =
      MutableMessage.of(
          "<red>Operacja nie została wykonana, gdyż nie udało się odnaleźć waluty z id pasującym do <yellow>{currencyId}<red>.");
}
