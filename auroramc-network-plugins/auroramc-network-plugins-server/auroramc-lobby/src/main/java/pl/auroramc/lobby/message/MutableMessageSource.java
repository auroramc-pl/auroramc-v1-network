...
public class MutableMessageSource extends OkaeriConfig {
  ...
  public DeliverableMutableMessage availableSchematicsSuggestion = DeliverableMutableMessage.of(
      MutableMessage.of(
          "<gray>Dostępne schematy: <white>{schematics}"
      )
  );
  ...
  public DeliverableMutableMessage teleportedIntoSpawn = DeliverableMutableMessage.of(
      MutableMessage.of(
          "<gray>Zostałeś przeteleportowany na spawn."
      )
  );

  public DeliverableMutableMessage lobbyClarification = DeliverableMutableMessage.of(
      MutableMessage.of(
          """
  ...
  public DeliverableMutableMessage teleportedFromVoid = DeliverableMutableMessage.of(
      MutableMessage.of(
