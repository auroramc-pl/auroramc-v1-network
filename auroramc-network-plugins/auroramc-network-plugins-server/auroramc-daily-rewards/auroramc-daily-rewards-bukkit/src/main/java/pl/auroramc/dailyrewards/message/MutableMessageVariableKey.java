...
public final class MutableMessageVariableKey {
  ...
  public static final String PLAYTIME_VARIABLE_KEY = "playtime";
  public static final String FROM_VARIABLE_KEY = "from";
  public static final String TO_VARIABLE_KEY = "to";
