...
public class MessageSource extends OkaeriConfig {
  ...
  public MutableMessage visitDailySummary = MutableMessage.of(
      "<gray>Wykaz sesji z dnia <white>{period}<gray>:"
  );

  public MutableMessage visitRangeSummary = MutableMessage.of(
      "<gray>Wykaz sesji z okresu <white>{from} <gray>- <white>{to}<gray>:"
  );
  ...
  public MutableMessage noVisits = MutableMessage.of(
      "<gray>Brak sesji w podanym okresie."
  );
}
